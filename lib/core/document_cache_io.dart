/// The file-backed implementation of the document-cache seam — macOS, iOS and
/// Android.
///
/// This is a move, not a rewrite: everything below is the file that used to sit
/// at `document_cache.dart`, unchanged. That path is now the
/// conditional-export barrel choosing between this and
/// `document_cache_web.dart`; read its library doc for the contract the two
/// share, and import *that* — never this file directly, or the browser build
/// gets `path_provider` and a `dart:io` stub again.
library;
